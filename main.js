...
var randomNo = Math.floor((Math.random() * quick_draw_data_set.length) + 1);

console.log(quick_draw_data_set[randomNo]);

sketch = quick_draw_data_set[randomNo];

document.getElementById("to_be_drawn").innerText = "To Be Drawn : " + sketch;
...
function check_sketch() {
    ...
    if(timer_check == "completed" || answer_check == "set"){
        timer_check = null;
        answer_check = null;
        UpdateCanvas();
    }
